...
const LessorList = () => {
  ...
  const archiveLessor = (id: string) => {
    const confirmed = window.confirm('Are you sure you want to archive this lessor?');
    if (confirmed) {
      axios
  ...
  return (
    <div className="p-6">
      <h2 className="text-3xl font-bold text-gray-800 mb-6">Users Management / Lessor</h2>
        ...
        <table className="min-w-full table-auto text-gray-700">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="px-4 py-2 border-b text-left whitespace-nowrap">ID Verified</th>
