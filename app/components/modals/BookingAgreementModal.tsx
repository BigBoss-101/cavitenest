  ...
  const content = (
    <div>
      ...
      <p className="mb-4">
        ...
        <strong>{bookingAddress || "Not Specified"}</strong>, to the Lessee for
        the agreed booking period. The Lessee will have access to the entire
        property, including all amenities listed within this Agreement, from the
        agreed check-in date and time of{" "}
        <strong>
      ...
      <p className="mb-4">
        ...
        , which is payable by{" "}
        <strong>{paymentMethod || "Not Specified"}</strong>. A security deposit
        of{" "}
        <strong>
          {" "}
          {bookingSecurityDeposit
      ...
      <p className="mb-4">
        ...
        condition as it was provided upon check-in, allowing for reasonable use.
      </p>
      <p className="mb-4">
        ...
        harmless the Host from any claims, damages, or liabilities arising from
      ...
      <p className="mb-4">
        ...
        laws of the Republic of the Philippines, Republic Act No. 7394, this Act
        shall be known as the “Consumer Act of the Philippines.”
      </p>
    </div>
  );
