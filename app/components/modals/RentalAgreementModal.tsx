  ...
  const content = (
    <div>
      ...
      <p className="mb-4">
        {rentalSecurityDeposit ? (
          <>
            ...
            total, an amount of{" "}
            <strong>{formatPrice(rentalSecurityDeposit)}</strong> shall be paid.
            This deposit will be held by the Lessor as security for damages,
            unpaid rent, or other expenses incurred due to the Lessee&quot;s
            occupancy. The security deposit will not be refundable to the Lessee
            upon the termination of this Agreement, subject to deductions for
            any damages or unpaid amounts.
          </>
        ) : (
          <>
      ...
      <p className="mb-4">
        ...
        the Lessor may terminate this contract, and the Lessee shall forfeit the
        security deposit.
      </p>
      <p className="mb-4">
        ...
        laws of the Republic of the Philippines, Republic Act No. 7394, also
